...
export default function ProfileAvatar({ foto }: AvatarProps) {
  ...
  return (
    <div className="relative mb-10">
      ...
      <a>
        <Button
          className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-[var(--button-color)] text-[var(--font-color2)] hover:!bg-[var(--hover-3-color)] hover:!text-white px-4 py-1 text-xs cursor-pointer rounded-full shadow-md transition-all opacity-100 sm:opacity-100"
          size="sm"
        >
          Alterar
        </Button>
