...
import { Crown, MoreVertical, Pencil, Trash2, User } from "lucide-react";
      ...
      <CardContent className="p-4">
        <div className="rounded-md border border-[var(--border-color)]">
          <div className="grid grid-cols-12 gap-2 bg-[var(--header-color)] p-4 font-medium text-[var(--font-color)]">
            <div className="col-span-2 md:col-span-1 text-center">Foto</div>
            <div className="col-span-6 md:col-span-4">Nome</div>
            <div className="hidden md:block md:col-span-4">Papel</div>
            ...
            {users.length > 0 ? (
              users.map((usuario) => (
                ...
                >
                  ...
                  <div className="col-span-6 md:col-span-4 truncate">
                    {usuario.name}
                  </div>
